...
tk.Label(WC, text="Weight in kg: ", font="Akzidenz-Grotesk 11  bold").grid(row=0, column=0, columnspan=1)
...
Albon_50mg_2_10_Used_For = tk.Label(Frame, text="Second option for Coccidia").grid(row=5, column=8)
...
Albon_500mg_2_10_Used_For = tk.Label(Frame, text="Second option for Coccidia").grid(row=7, column=8)
...
Amoxicillin_under7LB_Used_For = tk.Button(Frame, text="Antibiotic", command=lambda: webbrowser.open('https://hello.com/')).grid(row=8, column=8)
...
Amoxicillin_over7LB_Used_For = tk.Button(Frame, text="Antibiotic", command=lambda: webbrowser.open('https://hello.com/')).grid(row=9, column=8)
...
Azithromycin_Used_For = tk.Button(Frame, text="URI (feline) - second choice; round up", command=lambda: webbrowser.open('https://hello.com/')).grid(row=10, column=8)
...
Baytril_tablets_Used_For = tk.Button(Frame, text="Antibiotic, uses only if directed by DVM", command=lambda: webbrowser.open('https://hello.com/')).grid(row=11, column=8)
...
Baytril_22point7_Used_For = tk.Button(Frame, text="Antibiotic, use only if directed by DVM", command=lambda: webbrowser.open('https://hello.com/')).grid(row=12, column=8)
...
Baytril_100_Used_For = tk.Button(Frame, text="Antibiotic for severe URI if intolerant of oral meds; round down", command=lambda: webbrowser.open('https://hello.com/')).grid(row=13, column=8)
...
Cephalexin_250_500mg_tablets_Used_For = tk.Button(Frame, text="Skin - pyoderma in dogs", command=lambda: webbrowser.open('https://hello.com/')).grid(row=14, column=8)
...
Cerenia_10mg_Used_For = tk.Button(Frame, text="Nausea; quick dosing - 0.1 ml/kg", command=lambda: webbrowser.open('https://hello.com/')).grid(row=15, column=8)
...
Clindamycin_75_150mg_tablets_Used_For = tk.Button(Frame, text="Antibiotic; round up", command=lambda: webbrowser.open('https://hello.com/')).grid(row=16, column=8)
...
Clindamycin_25_Used_For = tk.Button(Frame, text="Antibiotic (Round up)", command=lambda: webbrowser.open('https://hello.com/')).grid(row=17, column=8)
...
Clavamox_under7lbs_Used_For = tk.Button(Frame, text="Antibiotic", command=lambda: webbrowser.open('https://hello.com/')).grid(row=18, column=8)
...
Clavamox_over7lbs_Used_For = tk.Button(Frame, text="Antibiotic", command=lambda: webbrowser.open('https://hello.com/')).grid(row=19, column=8)
...
Convenia_80_Used_For = tk.Button(Frame, text="Antibiotic; quick dosing - 0.1 ml/kg", command=lambda: webbrowser.open('https://hello.com/')).grid(row=20, column=8)
...
Doxycycline_50_Used_For = tk.Button(Frame, text="URI (primarily feline, can be used in small puppies)", command=lambda: webbrowser.open('https://hello.com/')).grid(row=21, column=8)
...
Doxycycline_100mg_tablets_Used_For = tk.Button(Frame, text="Kennel Cough", command=lambda: webbrowser.open('https://hello.com/')).grid(row=22, column=8)
...
Entyce_cats_Used_For = tk.Button(Frame, text="Anorexia", command=lambda: webbrowser.open('https://hello.com/')).grid(row=23, column=8)
...
Entyce_dogs_Used_For = tk.Button(Frame, text="Anorexia", command=lambda: webbrowser.open('https://hello.com/')).grid(row=24, column=8)
...
Famciclovir_250mg_Used_For = tk.Button(Frame, text="Feline URI (only to be Rx by Vet)", command=lambda: webbrowser.open('https://hello.com/')).grid(row=25, column=8)
...
Frontline_Used_For = tk.Button(Frame, text="Flea preventative", command=lambda: webbrowser.open('https://hello.com/')).grid(row=26, column=8)
...
Metronidazole_250_500mg_Tablets_Used_For = tk.Button(Frame, text="Diarrhea (round down)", command=lambda: webbrowser.open('https://hello.com/')).grid(row=27, column=8)
...
Metronidazole_50_Used_For = tk.Button(Frame, text="Diarrhea", command=lambda: webbrowser.open('https://hello.com/')).grid(row=28, column=8)
...
Panacur_1_Used_For = tk.Button(Frame, text="Roundworms, Hookworms, Whipworms", command=lambda: webbrowser.open('https://hello.com/')).grid(row=29, column=8)
...
Panacur_2_Used_For = tk.Button(Frame, text="Giardia", command=lambda: webbrowser.open('https://hello.com/')).grid(row=30, column=8)
...
Ponazuril_50_Used_For = tk.Button(Frame, text="Coccidia", command=lambda: webbrowser.open('https://hello.com/')).grid(row=31, column=8)
...
Ponazuril_150_Used_For = tk.Button(Frame, text="Coccidia", command=lambda: webbrowser.open('https://hello.com/')).grid(row=32, column=8)
...
Praziquantel_Used_For = tk.Button(Frame, text="Tapeworms", command=lambda: webbrowser.open('https://hello.com/')).grid(row=33, column=8)
...
Pyrantel_Pamoate_Used_For = tk.Button(Frame, text="Hookworms, Roundworms", command=lambda: webbrowser.open('https://hello.com/')).grid(row=34, column=8)
...
Revolution_Used_For = tk.Button(Frame, text="Ear mites, fleas, other mites", command=lambda: webbrowser.open('https://hello.com/')).grid(row=35, column=8)
...
Trazadone_Standard_Used_For = tk.Button(Frame, text="MUST be started and monitored by a veterinarian.", command=lambda: webbrowser.open('https://hello.com/')).grid(row=36, column=8)

Trazadone_High_Dosage = tk.Label(Frame, text="Trazadone High Dose").grid(row=37, column=0)
Trazadone_High_Dosage_Dosage = tk.Label(Frame, textvariable=f"{dose_value2}").grid(row=37, column=1)
...
Trazadone_High_Dosage_Used_For = tk.Button(Frame, text="MUST be started and monitored by a veterinarian.", command=lambda: webbrowser.open('https://hello.com/')).grid(row=37, column=8)
